      ...
      <div class="page-title"> <i class="icon-custom-left"></i>
        ...
        <div class="span12">
          <ul class="nav nav-tabs" id="tab-01">
            <li class="active"><a href="#tab1hellowWorld"> Hotels List </a></li>
            <li><a href="#tab1FollowUs"> + Add Hotels </a></li>
        ...
        <div class="span12">
          <div class="grid simple ">
            <div class="grid-title">
              <h4>Hotels <span class="semi-bold">List</span></h4>
              <div class="tools"> <a href="javascript:;" class="collapse"></a> <a href="#grid-config" data-toggle="modal" class="config"></a> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
            </div>
            ...
            <div class="download-icon">
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="table table-striped" id="example3" width="100%" >
                <thead>
                  <tr>
                    <th>Hotel Name</th>
                    <th>Description </th>
                ...
                <tbody>
                  <?php
				 $url = "http://192.168.1.242/Event-Manager/public/index.php/api/exa/hotel"; 
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="table table-striped" id="example2" width="100%" >
                ...
                <tbody>
                  <tr class="odd gradeX">
                    <td>Pershing Hall</td>
                    <td>Hello......</td>
                    <td>12 Abcd Indore India</td>
                    <td>123-456-7890</td>
                    <td> www.inwizards.com</td>
                    <td class="center"><a class="icon-plus-sign-alt"></a> &nbsp; <a class="icon-trash"></a></td>
                  </tr>
