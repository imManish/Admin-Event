  ...
  <div class="page-content"> 
    ...
    <div class="content">
      <div class="page-title"> <i class="icon-custom-left"></i>
        <h3><span class="semi-bold">Exhibitors</span></h3>
      </div>
      <div class="row-fluid">
        <div class="span12">
          <div class="grid simple ">
            <div class="grid-title">
              <h4>Exhibitors <span class="semi-bold">List</span></h4>
          ...
          <?php
          $url = "http://192.168.1.242/Event-Manager/public/index.php/api/exa/exhibitors/"; 
         ...
         // print_r($data['exhibitor']);
		  if(isset($data['exhibitor']) && $data['exhibitor']!=''){
          foreach($data['exhibitor'] as $value)
          {
          //echo $value['SpeakerName'];                      
          ?>
                  <tr class="odd gradeX">
                    <td><?php echo $value['featured_exhibitor']; ?></td>
                    <td><?php echo $value['company_name']; ?></td>
                    <td><?php echo $value['category']; ?></td>
                    <td><?php echo $value['website']; ?></td>
                    <td> <?php echo $value['max_booth_number']; ?></td>
