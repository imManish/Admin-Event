...
<div class="page-container row-fluid">
  ...
  <div class="page-sidebar" id="main-menu">
   ...
   <ul>
      ...
      <li class=""> <a href="index.html">  <img width="20" src="assets/img/home.png"/> <span class="title">Dashboard</span>  </a> </li>
      <li class=""> <a href="Speakers.html"> <img width="20" src="assets/img/icon_speakers@2x.png"/> <span class="title">Speakers</span>  </a> </li>
	  <li class=""> <a href="Sessions.html"> <img width="20" src="assets/img/Sessions.png"/> <span class="title">Sessions</span>  </a> </li>
	  ...
	  <li class="active"> <a href="Messaging.html"> <img width="20" src="assets/img/selecticon/messages@2x.png"/> <span class="title">Push Messaging</span>  </a> </li>
      <li class=""> <a href="Notifications.html"> <img width="20" src="assets/img/messages@2x.png"/> <span class="title">Push Notifications</span>  </a> </li>
      <li class=""> <a href="composemail.html"> <img width="20" src="assets/img/messages@2x.png"/> <span class="title">Compose Email</span>  </a> </li>
  ...
  <div class="page-title"> <i class="icon-custom-left"></i>
        <h3><span class="semi-bold">Messaging</span></h3>
      </div>
		...
		<div class="span12">
					<div class="grid simple ">
								<div class="grid-title no-border">
									<h4>Push  <span class="semi-bold">Messaging</span></h4>
									<div class="tools">
								...
								<br>
									...
									<div class="alert alert-success">
										<button data-dismiss="alert" class="close"></button>
										Success:&nbsp;The <a class="link" href="#">page</a> has been added.
									
									</div>
									<div class="alert alert-info">
										<button data-dismiss="alert" class="close"></button>
										Info:&nbsp;You have <a class="link" href="#">198</a> unread messages.
									</div>
									...
									<div style="display:none" id="animateAlert" class="alert">
										<button data-dismiss="alert" class="close"></button>
										 <a class="link" href="#">Danger:</a> Your monthly traffic is reaching limit.
									</div>
									<button id="btnFlip" type="button" class="btn btn-white btn-cons">Flip</button>
									<button id="btnShake" type="button" class="btn btn-success btn-cons">Shake</button>
									<button id="btnBouce" type="button" class="btn btn-white btn-cons">bouce</button>
									</div>
									</div>
								</div>
					</div>
