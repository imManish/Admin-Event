...
<li class=""> <a href="composemail.php"> <img width="20" src="assets/img/messages@2x.png"/> <span class="title">Compose Email</span>  </a> </li>
  ...
  <div class="page-title"> <i class="icon-custom-left"></i>
        <h3><span class="semi-bold">Sponsors</span></h3>
      </div>
        ...
        <div class="span12">
          <div class="grid simple ">
            <div class="grid-title">
              <h4>Sponsors <span class="semi-bold">List</span></h4>
              <div class="tools">
            ...
            <div class="download-icon">
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="table table-striped" id="example2" width="100%" >
                ...
                <?php
					...
					$url = "http://192.168.1.242/Event-Manager/public/index.php/api/exa/sponsors"; 
                  ...
                  <tr class="odd gradeX">
                    <td><?php echo $value['sponsorship_category']; ?></td>
                    <td><?php echo $value['sponsorship_category_descreption']; ?></td>
                    <td><?php echo $value['sponsor_logo']; ?></td>
