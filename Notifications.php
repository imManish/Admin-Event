  ...
  <div class="page-content"> 
    ...
    <div class="content">
      <div class="page-title"> <i class="icon-custom-left"></i>
        <h3><span class="semi-bold"> Notifications </span></h3>
      </div>
        ...
        <div class="span8">
         ...
         <div class="span4">
          <div class="grid simple">
           <div class="grid-title no-border">
           <center>
           <img src="assets/img/wanttosend.png"/>
         </center>
           </div>
          </div>
        </div>
          ...
          <div class="grid-body">
            <div class="">
              <div class="control-group">
                <label class="control-label"> Push Notification Name </label>
                <div class="controls">
                  <input type="text" class="span12 ">
                </div>
                <label class="control-label"> Push Notification </label>
                <div class="controls postion">
                  <textarea rows="15" class="span12 "> </textarea>
                  <button  class="btn btn-success btn-cons textareaSetbtn" type="button">You have 143 bytes left </button>
                  <button class="btn btn-success btn-cons right" type="button"> Submit </button>
                  <button class="btn btn-success btn-cons right" type="button"> Cancel </button><br>
        ...
        <div class="span12">
          <div class="grid simple ">
            <div class="grid-title">
              ...
              <button class="btn btn-default" type="button"><span class="icon-mobile-phone"></span> Push Notification </button>
