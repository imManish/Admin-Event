  ...
  <div class="page-content"> 
    ...
    <div class="content">
      <div class="page-title"> <i class="icon-custom-left"></i>
        <h3><span class="semi-bold">Booths</span></h3>
      </div>
      <div class="row-fluid">
        <div class="span12">
          <div class="grid simple ">
            <div class="grid-title">
              <h4>Booths <span class="semi-bold">List</span></h4>
            ...
            <div class="grid-body postion">
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="table table-striped" id="example2" width="100%" >
                ...
                <tbody>
                <?php
				  $url = "http://192.168.1.242/Event-Manager/public/index.php/api/exa/booths/"; 
        ...
        //  print_r($data['booths']);
          if(isset($data['booths']) && $data['booths']!=''){
		  foreach($data['booths'] as $value)
          {
          //echo $value['SpeakerName']; 
				 ?>
                  <tr class="odd gradeX">
                    <td> <?php echo $value['boothnumber']; ?></td>
                    <td><?php echo $value['companyName']; ?></td>
                    <td><select>
                        <option value="AK">Gold Premium</option>
                        <option value="HI">Blue Normal</option>
                        <option value="HI">Grey Disabled</option>
                      </select></td>
