...
<li class=""> <a href="composemail.php"> <img width="20" src="assets/img/messages@2x.png"/> <span class="title">Compose Email</span>  </a> </li>
  ...
  <div class="page-title"> <i class="icon-custom-left"></i>
        <h3><span class="semi-bold">Speakers</span></h3>
      </div>
        ...
        <div class="span12">
          <div class="grid simple ">
            <div class="grid-title">
              <h4>Speakers <span class="semi-bold">List</span></h4>
              <div class="tools">
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="table table-striped" id="example2" width="100%" >
                ...
                <tbody>
                 <?php
                        ...
                        $url = "http://192.168.1.242/Event-Manager/public/index.php/api/exa/speakers"; 
...
<h6> Add New Speakers </h6>
      <form action="Speakers_Save.php" method="post">
                        <div class="row-fluid">
                          <div class="span12">
                            <div class="grid simple">
                                  ...
                                  <div class="span12">
									...
									<div class="span6 SideMR">
                                      ...
                                      <label class="control-label"> Facebook account:<span> * </span> </label>
                                        ...
                                        <input type="text" name="company_name" class="span12" >
                                         <input type="hidden" name="event_id" class="span12" value="1" >
                                          <input type="hidden" name="photo" value="url.thms.com" class="span12" >
									...
									<div class="span6">
									 ...
									 <div class="control-group">
                                      ...
                                      <div class="controls">
                                       <textarea class="span12" name="gender" rows="6"> </textarea>
                                      </div>
									  </div>
